...
Winning ads in this category are not original. They are **18 hook archetypes** bolted
...
| `01-swipe/winners-index.md` | **Our 9 winners**, deconstructed + the winning DNA | Before briefing anything |
| `01-swipe/competitor-ad-index.md` | All 31 competitor ads: format, stage, awareness, hook, formula | Weekly, when adding new swipe |
| `01-swipe/deconstruction-protocol.md` | The Phase 1–6 protocol, written as a procedure | Every new competitor ad |
| `02-libraries/hook-bank.md` | 18 hook archetypes + templates + written hooks | Every brief |
...
| `07-variations/` | **18 shootable scripts** descended from our 9 winners | Ship these |
